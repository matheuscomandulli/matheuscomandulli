...
{
int opc;
char lista[5][40]={"NOVO JOGADOR", "JOGAR 2048", "INSTRUCOES", "RANKING",};
...
{   
     senha2[tam2] = getch();          
     if(senha2[tam2] == 0x08 && tam > 0)  //Backspace
     {   
        printf("\b \b"); 
        senha2[tam2] = 0x00;
        tam--;
...
system("cls");
printf("         __   ____    ______   ____           ___    ____    __ __   ____ ")
printf("        / /  / __ \  / ____/  / __ \         |__ \  / __ \  / // /  ( __ )")
printf("   __  / /  / / / / / / __   / / / /         __/ / / / / / / // /_ / __  |")
printf("  / /_/ /  / /_/ / / /_/ /  / /_/ /         / __/ / /_/ / /__  __// /_/ / ")
printf("  \____/   \____/  \____/   \____/         /____/ \____/    /_/   \____/  ")
